...
export const PoolConfig = {
    ...
    enemyplanethree: 'enemyplanethree',
    enemyplanefour: 'enemyplanefour',
    enemyplanefive: 'enemyplanefive',
    enemyplanesix: 'enemyplanesix',
    enemyplaneseven: 'enemyplaneseven',
    enemyplaneeight: 'enemyplaneeight',
    enemyplanenine: 'enemyplanenine',
    enemyplaneten: 'enemyplaneten',
    enemyplaneeleven: 'enemyplaneeleven',
    enemyplanetwelve: 'enemyplanetwelve'
}